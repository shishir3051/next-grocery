            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                ...
                <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                  <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Manage Fulfillment</h3>
                      ...
                      <button
                        ...
                        className={`px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider border transition-all ${
                          selectedOrder.status === s 
                            ? getStatusColor(s).replace('bg-', 'bg-').replace('border-', 'border-') + ' ring-2 ring-teal-500' 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                   <div className="space-y-3">
                     ...
                     <div className="text-sm space-y-1">
                        ...
                        <p className="text-slate-500 flex items-center gap-1 mt-1 font-bold">
                   ...
                   <div className="space-y-3">
                     ...
                     <div className="text-sm">
                        ...
                        <span className={`text-[10px] font-black uppercase inline-block mt-1 ${
              ...
              <div className="p-6 bg-slate-50 border-t border-slate-100">
                 <button 
                  onClick={() => setSelectedOrder(null)}
                  className="w-full py-4 bg-teal-600 text-white font-black rounded-2xl shadow-xl shadow-teal-600/20 hover:bg-teal-700 transition-all text-sm"
                 >
                   Close Details
                 </button>
              </div>
